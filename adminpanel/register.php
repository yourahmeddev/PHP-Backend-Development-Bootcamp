...
<body class="bg-gradient-primary">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                                ...
                                <input type="submit" name="register_submit" value="Register Now" class="btn btn-primary btn-user btn-block">
                                <hr>
    ...
    if(isset($_POST['register_submit'])){
         ...
         if($password == $repeatPassword){
            ...
            if($result){
                echo "You are Register on our Portal";
            }else{
                echo "Try Again For Registering";
            }
         }
    }
    ?>
